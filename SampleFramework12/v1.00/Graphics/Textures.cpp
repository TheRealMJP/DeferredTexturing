...
static const uint64 MaxSubResources = 1024;
static D3D12_PLACED_SUBRESOURCE_FOOTPRINT Layouts[MaxSubResources] = { };
static uint32 NumRows[MaxSubResources] = { 0 };
static uint64 RowSizes[MaxSubResources] = { 0 };
...
void LoadTexture(Texture& texture, const wchar* filePath, bool forceSRGB)
{
    ...
    Assert_(numSubResources <= MaxSubResources);
